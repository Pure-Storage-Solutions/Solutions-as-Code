pipeline {
    ...
    parameters {
        choice(choices: ['MySql','MSSQL', 'Postgres', 'Oracle','stac-m3', 'Commvault', 'cyberark3', 'Oracle-demo','k8s', 'Oracle-rac', 'keerthi-ubuntu', 'data'], description: 'Select the Solution to build', name: 'solution')
